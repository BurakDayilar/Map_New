...
if excel_file and selected_map_file != "-- Upload New Map --":
    ...
    if st.sidebar.button("Generate Maps"):
        with st.spinner("Generating maps..."):
            ...
            valid_centroids = merged["centroid"].dropna()
            center_lat = valid_centroids.y.mean() if not valid_centroids.empty else 39.0
            center_lon = valid_centroids.x.mean() if not valid_centroids.empty else 35.0
            ...
            for metric_col in metric_cols:
                ...
                if map_type == "Interactive (HTML)":
                    ...
                    ax.legend(handles=legend_patches, title=metric_col, loc="upper left", bbox_to_anchor=(1.02, 1))
